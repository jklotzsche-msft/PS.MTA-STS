...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PS.MTA-STS\functions", "$global:testroot\..\PS.MTA-STS\internal\functions"),
	
	[string]
	$ModuleName = "PS.MTA-STS",
...
$CommandPath = @(
    "$global:testroot\..\PS.MTA-STS\functions"
    "$global:testroot\..\PS.MTA-STS\internal\functions"
)
